...
// Add CSS animation for tags
const tagAnimationStyle = `
  @keyframes fadeIn {
    from {
      opacity: 0;
...
export function DocumentListItem({
  ...
  const getTagColor = (tagId: number) => {
    ...
    return colorOptions[tagId % colorOptions.length];
  };
  ...
  return (
    <>
      <style jsx>{tagAnimationStyle}</style>
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  target.parentElement!.innerHTML =
                    '<div class="flex items-center justify-center w-full h-full"><svg class="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></div>';
                }}
              />
            ) : (
              ...
              <div className="flex items-center mt-1 sm:mt-0 sm:ml-4">
                ...
                <div className="flex flex-wrap gap-1">
                    ...
                    document.tags.slice(0, 3).map((tagId, index) => {
                      ...
                      return (
                        <span
                          ...
                          ${bgColor} text-blue-600 shadow-sm transform transition-transform 
                        ...
                        >
                          <span className="flex items-center">
                            <span className="w-1.5 h-1.5 rounded-full bg-blue-600 mr-1 opacity-70"></span>
                  ...
                  {document.tags && document.tags.length > 3 && (
                    <span
                      className="text-xs bg-gray-200 text-gray-700 px-2 py-0.5 rounded-full hover:bg-gray-300 transition-colors cursor-pointer"
                      title={document.tags
                        .slice(3)
                        .map((tagId) => {
                          const tag = tags.find((t) => t.id === tagId);
